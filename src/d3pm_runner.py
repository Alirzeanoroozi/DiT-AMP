...
class D3PM(nn.Module):
    def __init__(self, x0_model: nn.Module, n_T: int, num_classes: int, hybrid_loss_coeff: float) -> None:
        ...
        q_mats = [q_mat_t] # these are cumulative
    ...
    def q_sample(self, x_0, t, noise):
        ...
        # print(x_0.shape, t.shape, self.q_mats.shape)
    ...
    def forward(self, x: torch.Tensor, cond: torch.Tensor = None) -> torch.Tensor:
        ...
        return self.hybrid_loss_coeff * vb_loss + ce_loss, {"vb_loss": vb_loss.detach().item(), "ce_loss": ce_loss.detach().item()}
